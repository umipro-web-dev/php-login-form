<template>
    <div class="w-100">
        <h2 class="text-center mb-5 pt-3">新規登録フォーム</h2>
        <div class="description text-center">
            <p>下記の三つの項目を入力し、送信してください。</p>
        </div>
        ...
        <br>    
        <br>
        <button class="btn btn-primary" @click="submit" data-bs-toggle="modal" data-bs-target="#loading">新規登録</button>
        </div>
